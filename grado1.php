...
<div id="email-form-container" class="email-form-container">
    <div class="email-form-header">
        <h2>Enviar mensaje a la IE</h2>
        <button id="minimize-button" class="minimize-button">-</button>
    </div>
    <form method="POST" class="email-form" onsubmit="return showMessage();">
...
minimizeButton.addEventListener("click", () => {
    emailFormContainer.classList.toggle("minimized");
    minimizeButton.textContent = emailFormContainer.classList.contains("minimized") ? "+" : "-";
});
